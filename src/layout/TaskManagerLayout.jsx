        ...
        <div className="flex min-h-screen overflow-x-scroll bg-gray-100">
            <div className="flex">
                ...
                >
                    ...
                    <nav className="mt-5">
                        <NavLink className="block py-2.5 px-4 hover:bg-gray-700 my-3" to="/task-manager">All Tasks</NavLink>
                        <NavLink className="block py-2.5 px-4 hover:bg-gray-700 my-3" to="all-tasks">Task Board</NavLink>
