        ...
        <div className="w-full sm:my-16 max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
            ...
            <form action="" className="space-y-6">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <input type="text" name="username" id="username" placeholder="Email" className="w-full px-4 py-3 rounded-md border border-slate-900 focus:outline-none focus:ring  " />
                </div>
                <div className="space-y-2 text-sm">
